...
const accountIntitialValues = {
  login:{
    view: 'login',
    heading: 'Login',
    subHeading: 'Gety access to your Orders, Wishlist and Recommendation'
  },
  signup:{
    view: 'signup',
...
const LoginDialog = ({ open, setOpen }) => {
  ...
  const [signup,setSignup] = useState(signupIntiitialValues);
  const handleClose = () => {
    setOpen(false);
          ...
          { account.view === 'login' 
           ? (
            ...
            <Wrapper>
              ...
              <TextField variant="standard" onChange={(e)=> onInputChange(e)} name = 'paasword' label="Enter Password" />
